...
class UCSDPed2_deepSVDD(VideoAnomalyDetectionDataset):
    """
    ...
    def raw_shape(self):
        ...
        Returns the shape of the raw examples (prior to patches).
        """
        return 1, self.window_size, 256, 384  # TODO：疑问，UCSD iamge 的原始大小是： 238x158x1, 那这里 raw_shape 是 ？？
    ...
    def crop_shape(self):
        ...
        Returns the shape of examples (patches).
        """
        return 1, self.window_size//2, 32, 32  # TODO：这个 crop的物理过程到底是怎样？
...
class UCSDPed2_deepSVDD_TRAIN(VideoAnomalyDetectionDataset):
    """
    Models UCSD Ped2 dataset for video anomaly detection.
    """
    ...
    def crop_shape(self):
        ...
        Returns the shape of examples (patches).
        """
        return 1, self.window_size//2, 32, 32  # TODO：这个 crop的物理过程到底是怎样？8是什么意思？
