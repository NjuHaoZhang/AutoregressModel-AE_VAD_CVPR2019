...
# for Training
class MNIST_TRAIN(OneClassDataset):
    """
    ...
    def __getitem__(self, i):
        ...
        if self.mode == 'test':
            ...
            sample = x, int(y == self.normal_class) # label: 0 or 1
...
def test_train():
    ...
    #
    dataset = MNIST_TRAIN(path="/home/zh/Papers_Code/CVPR2019_pytorch_VAD/"
                               "novelty-detection/data/MNIST")
    cl = 1 # normal classes : 0,1,2...
    dataset.train(cl)
    # print("len(train_split): ", len(dataset.train_split)) # 60000
    # print("len(train_idxs): ", len(dataset.train_idxs)) # 0.9 * 60000 for train, else for val
