...
def test_test_load_test_ids():
    dataset = UCSDPed1(path='/home/zh/Papers_Code/CVPR2019_pytorch_VAD'
...
class UCSDPed1_TRAIN(VideoAnomalyDetectionDataset):
    """
...
def test_TRAIN():
    dataset = UCSDPed1_TRAIN(path='/home/zh/Papers_Code/CVPR2019_pytorch_VAD'
                                  '/novelty-detection/data/UCSD_Anomaly_Dataset.v1p2')
